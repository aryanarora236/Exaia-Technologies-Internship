...
def main():
    try:
        ...
        few_shot_block = (
            "Here are some example comments from control users:\n\n"
            f"{control_context}\n\n"
        )
        ...
        for i in range(1, total_posts + 1):
            ...
            persona = (
                ...
                f"{profile['occupation']}, and interested in {interests}."
            )
        ...
        outfn = f"/home/yc663354/testing/GenerationScripts/CONTROLScripts/FINALVERSION_5400_CONTROL_META_ATTRIBUTE_FEW_SHOT.csv"
