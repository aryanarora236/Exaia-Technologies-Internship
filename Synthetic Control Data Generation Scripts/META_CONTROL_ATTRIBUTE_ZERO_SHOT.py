    ...
    try:
        ...
        for i in range(1, total_posts + 1):
            ...
            persona = (
                ...
                f"{profile['marital_status']}, working as a {profile['occupation']}, and "
        ...
        outfn = f"/home/yc663354/testing/GenerationScripts/CONTROLScripts/FINALVERSION_5400_CONTROL_META_Attribute_Zero_Shot.csv"
