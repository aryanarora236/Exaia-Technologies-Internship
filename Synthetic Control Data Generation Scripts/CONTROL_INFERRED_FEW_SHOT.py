...
class PersonaFewShotGenerator:
    ...
    def get_cluster_extremes(self, cid: int, emb: np.ndarray) -> list:
    ...
    def select_diverse_clusters(self, sims: np.ndarray) -> tuple:
    ...
    def generate_few_shot_examples(self, emb: np.ndarray) -> list:
        """
        Generate six examples: the most- and least-similar comments from the top, median, and bottom clusters.
        """
...
Change the structure at the beginning of your response: it shouldn't follow the format of your previous posts.
        ...
        for idx, row in tqdm(personas_df.iterrows(), total=len(personas_df), desc="Processing personas"):
            ...
            persona_line = f"You are a Reddit user with the following persona: {row['persona_text']}."
        ...
        out_file = f"/home/yc663354/testing/GenerationScripts/CONTROLScripts/ACTUALFINAL_VERSION_CONTROL_5400_INFERRED_FEW_SHOT.csv"
