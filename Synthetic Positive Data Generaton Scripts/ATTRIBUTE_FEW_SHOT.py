...
def main():
    try:
        ...
        few_shot_block = (
            "Here are example comments written by different users:\n\n"
...
"""
        ...
        for i in range(1, total_posts + 1):
            ...
            persona_line = (
                ...
                f"You are diagnosed with the condition: {profile['condition']}."
            )
        ...
        outfn = f"/home/yc663354/testing/GenerationScripts/Trial_5400_Attribute_Few_Shot.csv"
